...
var TodoListUI = require("../components/TodoList");
...
function buildAppUI() {
    ...
    var todoListUI = new TodoListUI(bindingList, storage, bottomAppBarUI);
    var navBarUI = new NavBarUI(nav);
    var aboutUsUI = new AboutUsUI(nav);
    return new AppUI(addFormUI, todoListUI, bottomAppBarUI, navBarUI, aboutUsUI, nav);
}
