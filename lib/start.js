...
function buildTodosPage(todos, nav) {
    var appBar = new TodosPageAppBar();
    var navBar = new TodosPageNavBar(nav);
    var addForm = new TodosPageAddForm();
    var todoList = new TodosPageTodoList(todos, appBar.setCommandContext);
...
function buildApp() {
    ...
    var todos = createBindingList(storage.loadTodos());
