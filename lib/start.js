...
function buildAppUI() {
    ...
    var bottomAppBarUI = new BottomAppBarUI();
    var topAppBarUI = new TopAppBarUI();
    var listViewUI = new ListViewUI();
    return new AppUI(addFormUI, listViewUI, bottomAppBarUI, topAppBarUI);
}
